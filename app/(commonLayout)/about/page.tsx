...
const contactMethods = [
  {
    ...
    contact: "sadiksourov11@gmail.com",
    action: "mailto:sadiksourov11@gmail.com",
  ...
  },
  {
    ...
    contact: "+8801717375585",
    action: "tel:01717375585",
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-900/50 rounded-2xl p-6">
                ...
                <div className="flex gap-3">
                  <Link href="https://x.com/sadiksourov117" className="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-full flex items-center justify-center hover:bg-rose-500 hover:text-white transition">
                    <Twitter className="w-4 h-4" />
                  </Link>
                  <Link href="https://www.facebook.com/sadiksourov11/" className="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-full flex items-center justify-center hover:bg-rose-500 hover:text-white transition">
                    <Facebook className="w-4 h-4" />
                  </Link>
                  <Link href="https://www.instagram.com/sadiksourov11/" className="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-full flex items-center justify-center hover:bg-rose-500 hover:text-white transition">
                    <Instagram className="w-4 h-4" />
                  </Link>
                  <Link href="https://linkedin.com/in/sadiksourov11" className="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-full flex items-center justify-center hover:bg-rose-500 hover:text-white transition">
