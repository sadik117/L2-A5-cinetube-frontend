      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center px-4">
        <div className="text-center max-w-md animate-fadeInUp">
          <div className="relative w-32 h-32 mx-auto mb-6">
            <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-purple-600 rounded-full blur-2xl opacity-20" />
          ...
          <h2 className="text-3xl font-bold bg-gradient-to-r from-red-500 to-purple-600 bg-clip-text text-transparent mb-3">
            Your Watchlist is Empty
          </h2>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Discover amazing movies and series and add them to your watchlist for later.
          </p>
          <div className="flex gap-4 justify-center">
            <button
              onClick={() => router.push("/movies")}
              className="px-6 py-3 bg-gradient-to-r from-red-500 to-purple-600 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-red-500/25 transition-all duration-300 transform hover:scale-105 flex items-center gap-2"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 md:gap-5 lg:gap-6">
          {watchlist.map((item, index) => {
            ...
            const isNew = (Date.now() - addedDate.getTime()) < 7 * 24 * 60 * 60 * 1000;
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-2 right-2 px-2 py-1 bg-black/70 backdrop-blur-sm rounded-lg flex items-center gap-1">
                    <Star className={`w-3 h-3 ${getRatingColor(media.averageRating)} fill-current`} />
                    <span className={`text-xs font-bold ${getRatingColor(media.averageRating)}`}>
                  ...
                  {/* New Badge */}
                  {isNew && (
                    <div className="absolute bottom-2 left-2 px-2 py-1 bg-gradient-to-r from-red-500 to-purple-600 rounded-lg">
